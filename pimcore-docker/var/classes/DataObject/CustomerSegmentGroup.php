...
class CustomerSegmentGroup extends Concrete implements \Pimcore\Model\DataObject\DirtyIndicatorInterface {
...
public function setShowAsFilter ($showAsFilter) {
	$fd = $this->getClass()->getFieldDefinition("showAsFilter");
...
public function setExportNewsletterProvider ($exportNewsletterProvider) {
	$fd = $this->getClass()->getFieldDefinition("exportNewsletterProvider");
