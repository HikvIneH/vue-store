...
class TentSpecifications extends DataObject\Objectbrick\Data\AbstractData implements \Pimcore\Model\DataObject\DirtyIndicatorInterface {
...
/**
* TentSpecifications constructor.
...
public function setOutsideMaterial ($outsideMaterial) {
	$fd = $this->getDefinition()->getFieldDefinition("outsideMaterial");
...
public function setInsideMaterial ($insideMaterial) {
	$fd = $this->getDefinition()->getFieldDefinition("insideMaterial");
...
public function setFloorMaterial ($floorMaterial) {
	$fd = $this->getDefinition()->getFieldDefinition("floorMaterial");
...
public function setWaterproofRain ($waterproofRain) {
	$fd = $this->getDefinition()->getFieldDefinition("waterproofRain");
...
public function setWaterproofGround ($waterproofGround) {
	$fd = $this->getDefinition()->getFieldDefinition("waterproofGround");
...
public function setConstruction ($construction) {
	$fd = $this->getDefinition()->getFieldDefinition("construction");
...
public function setTentPegs ($tentPegs) {
	$fd = $this->getDefinition()->getFieldDefinition("tentPegs");
...
public function setIsMainSeamTaped ($isMainSeamTaped) {
	$fd = $this->getDefinition()->getFieldDefinition("isMainSeamTaped");
