...
class RucksackSpecs extends DataObject\Objectbrick\Data\AbstractData implements \Pimcore\Model\DataObject\DirtyIndicatorInterface {
...
public function setVolume ($volume) {
	$fd = $this->getDefinition()->getFieldDefinition("volume");
	$this->volume = $volume;
	return $this;
}
...
public function setLoad ($load) {
	$fd = $this->getDefinition()->getFieldDefinition("load");
	$this->load = $load;
	return $this;
}
...
public function setMaterial ($material) {
	$fd = $this->getDefinition()->getFieldDefinition("material");
...
public function setExpandTo ($expandTo) {
	$fd = $this->getDefinition()->getFieldDefinition("expandTo");
