...
class Approvals extends DataObject\Objectbrick\Data\AbstractData implements \Pimcore\Model\DataObject\DirtyIndicatorInterface {
...
public function setFifaApproved ($fifaApproved) {
	$fd = $this->getDefinition()->getFieldDefinition("fifaApproved");
...
public function setFifaInspected ($fifaInspected) {
	$fd = $this->getDefinition()->getFieldDefinition("fifaInspected");
...
public function setImsChecked ($imsChecked) {
	$fd = $this->getDefinition()->getFieldDefinition("imsChecked");
...
public function setIhfApproved ($ihfApproved) {
	$fd = $this->getDefinition()->getFieldDefinition("ihfApproved");
