...
class PaymentProviderWirecardSeamless extends DataObject\Objectbrick\Data\AbstractData implements \Pimcore\Model\DataObject\DirtyIndicatorInterface {
...
/**
* PaymentProviderWirecardSeamless constructor.
...
public function setAuth_paymentState ($auth_paymentState) {
	$fd = $this->getDefinition()->getFieldDefinition("auth_paymentState");
...
public function setAuth_gatewyReferenceNumber ($auth_gatewyReferenceNumber) {
	$fd = $this->getDefinition()->getFieldDefinition("auth_gatewyReferenceNumber");
