...
class PaymentProviderDatatrans extends DataObject\Objectbrick\Data\AbstractData implements \Pimcore\Model\DataObject\DirtyIndicatorInterface {
...
/**
* PaymentProviderDatatrans constructor.
...
public function setAuth_aliasCC ($auth_aliasCC) {
	$fd = $this->getDefinition()->getFieldDefinition("auth_aliasCC");
...
public function setAuth_maskedCC ($auth_maskedCC) {
	$fd = $this->getDefinition()->getFieldDefinition("auth_maskedCC");
...
public function setAuth_pmethod ($auth_pmethod) {
	$fd = $this->getDefinition()->getFieldDefinition("auth_pmethod");
...
public function setAuth_expm ($auth_expm) {
	$fd = $this->getDefinition()->getFieldDefinition("auth_expm");
...
public function setAuth_expy ($auth_expy) {
	$fd = $this->getDefinition()->getFieldDefinition("auth_expy");
...
public function setAuth_reqtype ($auth_reqtype) {
	$fd = $this->getDefinition()->getFieldDefinition("auth_reqtype");
...
public function setAuth_uppTransactionId ($auth_uppTransactionId) {
	$fd = $this->getDefinition()->getFieldDefinition("auth_uppTransactionId");
...
public function setAuth_refno ($auth_refno) {
	$fd = $this->getDefinition()->getFieldDefinition("auth_refno");
