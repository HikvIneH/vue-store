...
class PaymentProviderOGone extends DataObject\Objectbrick\Data\AbstractData implements \Pimcore\Model\DataObject\DirtyIndicatorInterface {
...
/**
* PaymentProviderOGone constructor.
...
public function setAuth_paymentMethod ($auth_paymentMethod) {
	$fd = $this->getDefinition()->getFieldDefinition("auth_paymentMethod");
...
public function setAuth_ip ($auth_ip) {
	$fd = $this->getDefinition()->getFieldDefinition("auth_ip");
...
public function setAuth_paymentId ($auth_paymentId) {
	$fd = $this->getDefinition()->getFieldDefinition("auth_paymentId");
...
public function setAuth_customerName ($auth_customerName) {
	$fd = $this->getDefinition()->getFieldDefinition("auth_customerName");
