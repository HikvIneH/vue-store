...
/**
* @method static \Pimcore\Model\DataObject\CoreShopQuoteItem\Listing getByLocalizedfields ($field, $value, $locale = null, $limit = 0) 
* @method static \Pimcore\Model\DataObject\CoreShopQuoteItem\Listing getByIsGiftItem ($value, $limit = 0) 
* @method static \Pimcore\Model\DataObject\CoreShopQuoteItem\Listing getByDigitalProduct ($value, $limit = 0) 
...
* @method static \Pimcore\Model\DataObject\CoreShopQuoteItem\Listing getByObjectId ($value, $limit = 0) 
* @method static \Pimcore\Model\DataObject\CoreShopQuoteItem\Listing getByMainObjectId ($value, $limit = 0) 
...
* @method static \Pimcore\Model\DataObject\CoreShopQuoteItem\Listing getByItemDiscountNet ($value, $limit = 0) 
* @method static \Pimcore\Model\DataObject\CoreShopQuoteItem\Listing getByItemDiscountGross ($value, $limit = 0) 
* @method static \Pimcore\Model\DataObject\CoreShopQuoteItem\Listing getByItemDiscountPriceNet ($value, $limit = 0) 
* @method static \Pimcore\Model\DataObject\CoreShopQuoteItem\Listing getByItemDiscountPriceGross ($value, $limit = 0) 
...
* @method static \Pimcore\Model\DataObject\CoreShopQuoteItem\Listing getByPimcoreAdjustmentTotalNet ($value, $limit = 0) 
* @method static \Pimcore\Model\DataObject\CoreShopQuoteItem\Listing getByPimcoreAdjustmentTotalGross ($value, $limit = 0) 
* @method static \Pimcore\Model\DataObject\CoreShopQuoteItem\Listing getByAdjustmentItems ($value, $limit = 0) 
...
* @method static \Pimcore\Model\DataObject\CoreShopQuoteItem\Listing getByBasePimcoreAdjustmentTotalNet ($value, $limit = 0) 
* @method static \Pimcore\Model\DataObject\CoreShopQuoteItem\Listing getByBasePimcoreAdjustmentTotalGross ($value, $limit = 0) 
* @method static \Pimcore\Model\DataObject\CoreShopQuoteItem\Listing getByBasePdjustmentItems ($value, $limit = 0) 
*/

class CoreShopQuoteItem extends \CoreShop\Component\Core\Model\QuoteItem implements \Pimcore\Model\DataObject\DirtyIndicatorInterface {
...
protected $o_className = "CoreShopQuoteItem";
