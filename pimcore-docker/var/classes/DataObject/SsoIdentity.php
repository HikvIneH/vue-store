...
class SsoIdentity extends \CustomerManagementFrameworkBundle\Model\AbstractSsoIdentity implements \Pimcore\Model\DataObject\DirtyIndicatorInterface {
...
public function setProvider ($provider) {
	$fd = $this->getClass()->getFieldDefinition("provider");
...
public function setIdentifier ($identifier) {
	$fd = $this->getClass()->getFieldDefinition("identifier");
...
public function setProfileData ($profileData) {
	$fd = $this->getClass()->getFieldDefinition("profileData");
