...
class installerProdDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->services = [];
        $this->normalizedIds = [
            'pimcore\\bundle\\installbundle\\command\\installcommand' => 'Pimcore\\Bundle\\InstallBundle\\Command\\InstallCommand',
        ...
        $this->fileMap = [
            'Pimcore\\Bundle\\InstallBundle\\Command\\InstallCommand' => 'getInstallCommandService.php',
    ...
    {
        return $this->services['debug.debug_handlers_listener'] = new \Symfony\Component\HttpKernel\EventListener\DebugHandlersListener(NULL, ${($_ = isset($this->services['monolog.logger.php']) ? $this->services['monolog.logger.php'] : $this->getMonolog_Logger_PhpService()) && false ?: '_'}, -1, -1, true, new \Symfony\Component\HttpKernel\Debug\FileLinkFormatter(NULL), true);
    }
        ...
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'PimcoreInstallBundle' => [
                    'parent' => NULL,
                    'path' => ($this->targetDirs[4].'/vendor/pimcore/pimcore/bundles/InstallBundle'),
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'secret' => 'installer-5c934aa8a7e603.71167030',
            'fragment.renderer.hinclude.global_template' => '',
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'installer-5c934aa8a7e603.71167030',
            ...
            'console.command.ids' => [
                ...
                'console.command.pimcore_bundle_installbundle_command_installcommand' => 'Pimcore\\Bundle\\InstallBundle\\Command\\InstallCommand',
            ],
